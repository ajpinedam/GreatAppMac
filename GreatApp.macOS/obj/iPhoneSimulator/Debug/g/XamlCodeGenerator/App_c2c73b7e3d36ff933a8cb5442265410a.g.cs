...
namespace GreatApp
{
	...
	public partial class App : Windows.UI.Xaml.Application
	{
		private void InitializeComponent()
		{
			...
			.Apply((c0 => 
			{
				// Source /Users/apineda/develop/uno/GreatApp/GreatApp.Shared/App.xaml (Line 1:2)
			...
			global::GreatApp.macOS.GlobalStaticResources.Initialize();
			global::GreatApp.macOS.GlobalStaticResources.RegisterResourceDictionariesBySourceLocal();
			global::Uno.UI.DataBinding.BindableMetadata.Provider = new global::GreatApp.macOS.BindableMetadataProvider();
			#if __ANDROID__
			global::Uno.Helpers.DrawableHelper.Drawables = typeof(global::GreatApp.macOS.Resource.Drawable);
			#endif
			// Source ../../../../../../GreatApp.Shared/App.xaml (Line 1:2)
		}
...
{
	static class App_c2c73b7e3d36ff933a8cb5442265410aXamlApplyExtensions
	{
	}
}
